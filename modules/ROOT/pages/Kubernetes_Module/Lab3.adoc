...
In this lab, you will learn how to get started using Open Shift by deploying a sample application to kubernetes on an OpenShift service hosted by IBM Cloud.  The sample application is built using Java 8.

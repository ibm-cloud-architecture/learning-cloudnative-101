...
To store the config, we use `.properties` file. You can find it https://github.com/ibm-cloud-architecture/cloudnative_sample_app/blob/master/src/main/resources/application.properties[here].

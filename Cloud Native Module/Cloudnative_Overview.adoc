...
[big grey]*Disposable Infrastructure*
...
[big grey]*Disposable architecture*
...
[big blue]*Value added cloud services*
...
[big grey]*Self-sufficient, full-stack teams*

...
1. IBM Kubernetes (IKS) cluster name: 
   <br/>[cluster_name]<hr/>
1. Postgres database name:  
   <br/>[database_name]<hr/>
1. Target resource group for the cluster: 
   <br/>[resource_group_name]<hr/>
1. The location of a yaml file that is used to access the database: 
   <br/>[path]/postgress-secret.yaml<hr/>

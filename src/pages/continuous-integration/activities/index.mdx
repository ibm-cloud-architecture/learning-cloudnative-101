...
- To deploy the Tekton pipelines:
    ```
   oc apply --filename https://raw.githubusercontent.com/ibm-cloud-architecture/learning-cloudnative-101/oc-tekton-lab/static/yamls/tekton-lab/tekton-operator.yaml
    ```

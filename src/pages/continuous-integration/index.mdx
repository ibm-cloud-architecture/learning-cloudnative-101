...
- Presentation: [IBM Cloud DevOps with Tekton](/slides/10-IBM-Cloud-DevOps.pdf)
...
| *** Try It Yourself ***                         |         |         |     |
| Tekton Lab | Using Tekton to build container images | [Tekton](../continuous-integration/activities/) | 1 hour |
...
| Jenkins Lab | Using Jenkins to build and deploy applications. | [Jenkins](../continuous-integration/activities/jenkins-lab/) | 1 hour |

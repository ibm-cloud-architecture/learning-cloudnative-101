...
<CardGroup>
<MiniCard title="IBM Cloud Logging with Sysdig PDF" href="/slides/09-IBM-Cloud-Logging-with-LogDNA.pdf">
</MiniCard>
<MiniCard title="IBM Cloud Logging with Sysdig" href="https://www.ibm.com/cloud/log-analysis">
</MiniCard>
<MiniCard title="Observability in IBM Cloud" href="https://cloud.ibm.com/observe">
</MiniCard>
<MiniCard title="IBM Cloud Logging with LogDNA" href="https://cloud.ibm.com/docs/Log-Analysis-with-LogDNA">
</MiniCard>
</CardGroup>
...
| Activity                        | Link       |
| --------------------------------|----------- |
| Install LogDNA agent on IBM Kubernetes Service (IKS)|  [LogDNA with IKS](../logdna/activities/iks/) |
...
| Install LogDNA agent on minikube |  [LogDNA with minikube](../logdna/activities/minikube/) |
| Using LogDNA Dashboard |  [LogDNA Dashboards](../logdna/activities/dashboards/) |
| Alerts with LogDNA |  [Alerts with LogDNA](../logdna/activities/alerts/) |
| JSON logs with LogDNA |  [JSON logs with LogDNA ](../logdna/activities/logger/nodejs) |

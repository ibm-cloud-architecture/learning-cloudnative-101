...
<AnchorLinks>
  ...
  <AnchorLink>Create accounts</AnchorLink>
  <AnchorLink>Windows Users</AnchorLink>
  <AnchorLink>Mac/Linux Users</AnchorLink>
  <AnchorLink>Install CLIs and tools</AnchorLink>
  <AnchorLink>Environment Setup</AnchorLink>
  <AnchorLink>Reading Material</AnchorLink>
</AnchorLinks>
...
```
wget -O - https://github.com/ibm-cloud-architecture/learning-cloudnative-101/blob/master/static/scripts/setup/system-check.sh | bash
```

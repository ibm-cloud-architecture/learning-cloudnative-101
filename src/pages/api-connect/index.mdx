...
- Presentation: [API Connect PDF](/slides/201-API-Connect.pdf)
...
| API Analytics| Covers getting the analytics for your API's. | See [Docs](https://ibm-apiconnect.github.io/test-and-monitor/) 
...
| API Analytics | Creating and Viewing API Analytics. | [API Analytics](./activities/apiAnalytics) |

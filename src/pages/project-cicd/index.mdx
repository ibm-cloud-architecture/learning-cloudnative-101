...
### Code Git Repository
- [Git repository with application code](https://github.com/csantanapr/tutorial-tekton-argocd-code)
- Create a new git repository using this repo as [template](https://github.com/csantanapr/tutorial-tekton-argocd-code/generate)
- Use the `Dockerfile` on the root of the repository to build a container image

### Infra Git Repository
- [Git repository with application manifest](https://github.com/csantanapr/tutorial-tekton-argocd-infra)
- Create a new git repository using this repo as [template](https://github.com/csantanapr/tutorial-tekton-argocd-infra/generate)
